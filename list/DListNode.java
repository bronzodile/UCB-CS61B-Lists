...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DListNode curr = ((DList)this.myList).newNode(item, (DList)this.myList, this,this.next); 
    this.next = curr;
    curr.next.prev = curr;
    this.myList.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
    DListNode curr = ((DList)this.myList).newNode(item, (DList)this.myList, this.prev, this); 
    this.prev = curr;
    curr.prev.next = curr;
    this.myList.size++;
